...
export class ProcurementContentService extends BaseSingletonService<ProcurementContentDocument> {
  constructor(
    @InjectModel(ProcurementContent.name)
    model: Model<ProcurementContentDocument>,
  ) {
...
export const PAGES_PROVIDERS = [PagesService, ProcurementContentService];
export const PAGES_CONTROLLERS = [PagesController, ProcurementContentController];
