...
const STAT_CARDS = [
  {
    ...
    icon: 'Leaf',
    statValue: '600+ га',
    title: ls('Биологийн нөхөн сэргээлт', 'Biological Reclamation'),
    description: ls('Талбайд биологийн нөхөн сэргээлт хийсэн.', 'Biologically reclaimed area'),
  ...
  },
  {
    ...
    icon: 'Award',
    statValue: '16 га',
    title: ls('Тосон нуур', 'Toson Lake'),
    description: ls('Талбайд цэнгэг уст Тосон нуур байгуулсан', 'Freshwater Toson Lake established'),
    colorTheme: 'beige',
    order: 1,
    isActive: true,
  },
  {
    ...
    icon: 'Sprout',
    statValue: '300+ га',
    title: ls('Олон наст ургамал', 'Perennial Plants'),
    description: ls('Талбайд бэлчээрийн олон наст ургамал тарьж, ургуулсан.', 'Perennial pasture plants cultivated'),
    colorTheme: 'white',
    order: 2,
    isActive: true,
  },
  {
    ...
    icon: 'Trees',
    statValue: '5 га',
    title: ls('Жимс жимсгэнэ', 'Berry Bushes'),
    description: ls('Талбайд жимс, жимсгэнийн мод бут тариалсан.', 'Fruit trees and berry bushes planted'),
    colorTheme: 'light-blue',
    order: 3,
    isActive: true,
  },
...
const PAGES = [
  { key: 'about', navLabel: ls('Бидний тухай', 'About Us'), header: { tag: ls('Бидний тухай', 'About Us'), title: ls('Бидний тухай', 'About Us'), subtitle: ls('Монполимет групп', 'Monpolymet Group') }, isActive: true },
